...
- ⌨️ Apps I use: `IntelliJ IDEA`, `VS Code`, `Vim`, `iTerm 2`, `Zsh`, `oh-my-zsh`, `Starship Prompt`, `BetterTouchTools`, `Karabiner`, `Keyboard Maestro`, `Alfred`, `Spotify`, `SetApp`, `Safari`, `Dark Reader for Safari`
